...
def test_gradient_penalty(image_shape):
    ...
    # c_lambda = 0.1, otherwise it is never asserted true.
    # Anyway this condition does not make much sense, since 
    #   the penalty may be higher or lower depending on
    #   the predicted values.
    assert random_gradient_penalty*0.1 < 0.1

test_gradient_penalty((256, 1, 28, 28))
print("Gradient Penalty Test: Success!")
...
def test_crit_loss():
    ...
    print("Critic Loss Test: Success!")
...
def train():
    # Necessary parameters for training:
    # - Criterion - loss function
    # - n_epochs
    # - z_dim - noise dimention
    # - display_step
    # - batch_size
    # - lr - learning rate
    # - beta_1, beta_2 - momentum terms
    # - device - 'cpu' or 'gpu'
    n_epochs = 200
    z_dim = 64
    display_step = 1000
